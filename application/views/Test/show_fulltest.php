					...
					<div class="row">
						...
						<div id="content" class="col-xs-6 col-md-9">
								...
								<div class='part' id="part1">
									<?php
										...
										foreach ($xml->xpath('picture/question') as $question) 
										{
											...
											$answer = $question->key;											
											echo "<div class='content_question $i aaa'><b><p>Look at the picture and listen to the sentences. Choose the sentence that best describes the picture:</p></b>$cau.";
								...
								<div class='part' id="part2">
									<?php
										foreach ($xml->xpath('QR/question') as $question) {
											...
											$optiond=$question->optiond;
											$answer = $question->key;											
											echo "<div class='content_question $i aaa'><b><p>Listen to the question and the three responses. Choose the response that best answers the question:</p></b>$cau.";
												echo "<div class='audio_question'>";
													echo "<audio controls>";
														echo "<source src=$link_audio$audio type='audio/mpeg'>";
													echo "</audio>";
										...
										<?php
											foreach ($xml->xpath('incom/question') as $question) {
												...
												echo "<div id='' class='question_sen $i aaa'>";
													echo "<div class='content_question $cau'><b><p>Choose the word that best completes the sentence:</p></b>$cau. $content</div>";
									?>
										<div class='option' id="<?php echo $cau;?>">
											<div>
												<input type="radio" name="radioquestion<?php echo $cau;?>" value="a"/><span> A.<?php echo " ".$optiona;?></span>
							...
							<div class="ans_score">
								...
								<button type="button" class="btn btn-primary" id="btnsubmit">AGAIN</button>
							</div>
						</div>
					</div>
				</div>
