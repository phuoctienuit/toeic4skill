...
<div id="content"> 
	...
	<div class="form_score">
		<form class="form-horizontal" action="<?php echo base_url()?>index.php/admin/delete_link_video/<?php echo $a['id'];?>" method="post">
		<fieldset>

		<!-- Form Name -->
		<legend align="center">XÁC NHẬN XÓA LINK CHIA SẺ VIDEO</legend>
