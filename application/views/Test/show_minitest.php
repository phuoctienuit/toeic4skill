				...
				<div class="container">
					<div class="row">
						...
						<div id="content" class="col-xs-6 col-md-9">
							...
							<div class="next_pre">
								<button type="button" class="btn btn-primary" id="btnanswer">PREVIOUS</button>
								<button type="button" class="btn btn-primary" id="btnsubmit">NEXT</button>
							</div>
							<div class="ans_score">
								<center><p>Result: /200</p></center>
