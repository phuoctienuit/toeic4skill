...
<html>
	...
	<head>
		...
		<script src="<?php echo base_url(); ?>application/template/js/minitest.js"></script>
				...
				<div class="container">
					<div class="row">
						...
						<div id="content" class="col-xs-6 col-md-9">
							<div class="timer">
								<span class="hour"><span id="hh">01</span> Hours</span>
							...
							<div class="minitest">
								<div class="test_content">
									<div class='part' id="part1">
										<?php
											$i=0;
											$xml=simplexml_load_file($minitest_path);
								...
								<div class="ans_score">
									<center><p>Result: <span id="result">0</span> /100</p></center>
