...
<div id="content"> 
  ...
  <div class="title_photo">
      <p>ADD FILE XML <b>READING COMPREHENSION</b></p>

  </div>
  <div id="upload_form">
    <form action="<?php echo base_url("index.php/admin/upload_file_reading_compre"); ?>" method="post" enctype="multipart/form-data">
