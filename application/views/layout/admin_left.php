    ...
    <div class="toplinks style1" id="navigationtitle"><strong>Xem Đề Thi</strong><br> <!--// Title -->
      ...
      <table width="158" border="0">
        ...
        <tr>
          ...
          <td class="navigation"><a href="<?php echo base_url()?>index.php/admin/list_file_qr">Q&amp;R</a></td> <!--// Articles -->
        </tr>
        <tr>
          ...
          <td class="navigation"><a href="<?php echo base_url()?>index.php/admin/list_file_short_con">Short Conversation</a></td> <!--// Galleries -->
        </tr>
        <tr>
          <td align="center"><img src="http://localhost/toeic4skill/application/template/image/eye.png" alt="calendar" width="15" height="15"></td>
          <td class="navigation"><a href="<?php echo base_url()?>index.php/admin/list_file_short_talk">Short talk</a></td> <!--// Calendar -->
        </tr>
        <tr>
          <td align="center"><img src="http://localhost/toeic4skill/application/template/image/eye.png" alt="users" width="16" height="18"></td>
          <td class="navigation"><a href="<?php echo base_url()?>index.php/admin/list_file_incom">Incom Sentences</a></td> <!--// Users -->
        </tr>
        <tr>
          ...
          <td class="navigation"><a href="<?php echo base_url()?>index.php/admin/list_file_text_com">Text complextion</a></td> <!--// Statistics -->
        </tr>
        <tr>
