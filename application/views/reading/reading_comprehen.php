				...
				<div class="container">
					<div class="row">
						...
						<div id="content" class="col-xs-6 col-md-9">
							...
							<?php 
							foreach($reading_comprehen_id as $a)
							{
						?>
							<div class="reading_comprehen_test">
								<a href="<?php echo base_url(); ?>index.php/main/show_reading_comprehen/<?php echo $a['id'];?>"><?php echo 'Đề luyện tập số '.$a['id']?></a>
							</div>
