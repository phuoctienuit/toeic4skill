  ...
  <div class="title_file">DANH SÁCH CÁC ĐỀ THI</div>
    <div class="content_file"> 
        ...
        <div id="file_500">
            ...
            <div class='filename'> 
                   <a target = '_blank' href="<?php echo base_url() ;?>index.php/admin/view_file_short_talk/<?php echo $file; ?>"> <?php echo $file; ?></a>
            </div>
      ...
      <div id="file_750">
        <div>LEVEL 750</div>
            ...
            ?>
                    ...
                    <div class='filename'> 
                           <a target = '_blank' href="<?php echo base_url() ;?>index.php/admin/view_file_short_talk/<?php echo $file1; ?>"> <?php echo $file1; ?><a/>
                    </div>
                    <div class='image_edit'>
                            <img src='<?php echo $link_image;?>edit.png' width='25' height='25'>
      ...
      <div id="file_900">
         <div>LEVEL 900</div>
            ...
            ?>
                    ...
                    <div class='filename'> 
                           <a target = '_blank' href="<?php echo base_url() ;?>index.php/admin/view_file_short_talk/<?php echo $file2; ?>"> <?php echo $file2; ?><a/>
                    </div>
                    <div class='image_edit'>
                            <img src='<?php echo $link_image;?>edit.png' width='25' height='25'>
