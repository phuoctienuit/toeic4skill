...
<body style="background-color: antiquewhite">
	...
	<div id="title" style="background-color: rgb(236, 229, 229)">
		CHỈNH SỬA BÀI CHIA SẺ KINH NGHIỆM WRITING
	</div>
		<?php
		foreach($array_post as $post)
		?>
	<div id="content_sharing" style="background-color: rgb(245, 231, 231)" >
        <form action="<?php echo base_url();?>index.php/admin/update_writing" method="post" >
        
			<div class="form-group">
			  	
			  <input id="id" name="id" value="<?php echo $post['id']; ?>" type="hidden" class="textbox1">
			...
			<input id="name" name="type" value="<?php echo $post['type']; ?>" type="hidden" class="textbox1">
			   
			 <div class="form-group">
			  	<label>Chuyên mục</label>
			  <input id="skill" name="skill" disabled="disabled" value="<?php echo $sharing_writing; ?>" type="text" class="textbox1">
