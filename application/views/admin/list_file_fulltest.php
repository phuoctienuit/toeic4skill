...
<div id="content"> 
  ...
  <div class="title_file">DANH SÁCH CÁC ĐỀ THI FULLTEST</div>
    <div class="content_file"> 
        ...
        <div id="file_500">
            ...
            <div class='filename'> 
                   <a target = '_blank' href="<?php echo base_url() ;?>index.php/admin/view_file_fulltest/<?php echo $file; ?>"> <?php echo $file; ?></a>
            </div>
